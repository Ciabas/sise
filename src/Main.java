...
public final class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("-i /--idfs porzÄ…dek	Strategia przeszukiwania w gÅ‚Ä…b z iteracyjnym pogÅ‚Ä™bianiem (id: 3)");
		...
		case("-a"):
			case("--a"):
				if(parts.length == 3){
					...
					switch(order[0]){
					case "1":
						System.out.println("Heurystyka poprawnoÅ›ci rzÄ™dÃ³w");
						break;
					case "2":
						System.out.println("Heurystyka odlegÅ‚oÅ›ci od rozwiÄ…zania");
						break;
					}
					switch(strategy_id){
					case 1:
